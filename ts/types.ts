...
export type Scalars = {
  ...
  DateTimeAuto: { input: any; output: any; }
...
export enum AllianceTreatiesOrderByColumn {
  Id = 'ID',
  Date = 'DATE',
...
export enum AllianceTaxBracketsOrderByColumn {
  Id = 'ID',
  Date = 'DATE',
...
export enum AllianceWarsOrderByColumn {
  Id = 'ID',
  Date = 'DATE'
}
...
export enum NationWarsOrderByColumn {
  Id = 'ID',
  Date = 'DATE'
}
...
export enum NationTradesOrderByColumn {
  Id = 'ID',
  Date = 'DATE',
...
export enum DefaultAlliancePosition {
  Remove = 'REMOVE',
  Applicant = 'APPLICANT',
  Member = 'MEMBER',
  Officer = 'OFFICER',
