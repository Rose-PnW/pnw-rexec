...
type NationChildArgs<Child> = Child extends 'wars' ? NationWarsArgs : Child extends 'offensivewars' ? NationWarsArgs : Child extends 'defensivewars' ? NationWarsArgs : Child extends 'bankrecs' ? NationBankrecsArgs : Child extends 'taxrecs' ? NationBankrecsArgs : never;
